...
When [h2c] is running and connected, you can start sending a ping every second like this:

{% highlight bash %}
h2c ping --interval 1s
{% endhighlight %}
...
The following shows how to experiment with timeouts and ping frames with the three major [Java] [HTTP/2] servers.
